          ...
          >
            ...
            <div className="mt-8 md:hidden">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-2xl font-bold transition-all transform hover:scale-105 shadow-lg shadow-green-600/20 w-full"
              >
                <svg 
                  viewBox="0 0 24 24" 
                  className="w-6 h-6 fill-current"
